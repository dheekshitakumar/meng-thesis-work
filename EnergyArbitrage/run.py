...
num_eps = 10000
C = 1000
df_file = './data/Prices2013_winterweek.csv'
...
memory = 10000 #how many examples do we want to remember in the past
...
def train():
    ...
    #DQN_target = torch.load("dqn_target_winter_reset_8_newenv.pt")
    #DQN_current = torch.load("dqn_current_winter_reset_8_newenv.pt")
    ...
    for e in range(num_eps):
        ...
        while done == False: #for t = 1,....,T
            ...
            #targets = DQN_target.remove_invalid(s_next_batch, targets)
            #print("s_next_batch: ", s_next_batch[:,0])
